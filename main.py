...
# ==================================================
# 2. データ処理（dataフォルダから全自動読み込み）
# ==================================================
DATA_DIR = "data"
all_data = []

# dataフォルダ内のCSVファイルを自動ですべて統合
...
if all_data:
    ...
    st.warning("⚠️ dataフォルダ内にCSVファイルが見つかりません。GitHubのdataフォルダにファイルをアップロードしてください。")
